...
python3 scripts/slot_tagging.py --task $task --dataset $dataset --dataroot $dataroot --bidirectional --lr $lr --dropout $dp --batchSize $bs --optim $opt --max_norm $mn --experiment exp --deviceId -1 --max_epoch $me --emb_size $es --hidden_size $hs --mini_word_freq $mwf 
